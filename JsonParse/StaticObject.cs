...
namespace Caliber.Json
{
    public static partial class StaticObject
    {
        public class Static
        {
            ...
            public Dictionary<string, List<CardLevel>> CardLevels { get; set; }
            public List<MedalGroup> MedalGroups { get; set; }
            public Dictionary<string, long> Ribbons { get; set; }
            public List<CustomAnimation> CustomAnimations { get; set; }
            public ModesRewards ModesRewards { get; set; }
            public LevelRewardsConfigs LevelRewardsConfigs { get; set; }
            public List<OnboardingScreen> OnboardingScreens { get; set; }
            public List<AccountLevelElement> AccountLevels { get; set; }
            public Accesses Accesses { get; set; }
            public Dictionary<string, Collection> Collections { get; set; }
            public Dictionary<string, SkinGroup> SkinGroups { get; set; }
            public Dictionary<string, Skin> Skins { get; set; }
            public List<BaseAvailableCard> BaseAvailableCards { get; set; }
            public BattlePasses BattlePasses { get; set; }
            public MarathonConfigs MarathonConfigs { get; set; }
            public RankedSeasonConfigs RankedSeasonConfigs { get; set; }
            public ExpeditionConfigs ExpeditionConfigs { get; set; }
            public ExpeditionRewardConfigs ExpeditionRewardConfigs { get; set; }
            public ExpeditionCardRoleConfigs ExpeditionCardRoleConfigs { get; set; }
            public ExpeditionCardLevelConfigs ExpeditionCardLevelConfigs { get; set; }
            public Dictionary<string, ExpeditionVisualConfig> ExpeditionVisualConfigs { get; set; }
            public ConsumableSlots ConsumableSlots { get; set; }
            public Currencies Currencies { get; set; }
            public LootBoxes LootBoxes { get; set; }
            public Dictionary<string, Userbar> Userbars { get; set; }
            public Dictionary<string, Firework> HqStyles { get; set; }
            public SpecialOffers SpecialOffers { get; set; }
            public QuartersClass Quarters { get; set; }
            public QuartersBoosters QuartersBoosters { get; set; }
            public Dictionary<string, Firework> Fireworks { get; set; }
            public FoulPlayConfigs FoulPlayConfigs { get; set; }
            public SurrenderConfigs SurrenderConfigs { get; set; }
            public NewbieBuffModifiers NewbieBuffModifiers { get; set; }
            public HumanConfigs HumanConfigs { get; set; }
            public Dictionary<string, WeaponConfig> WeaponConfigs { get; set; }
            public ConsumableConfigs ConsumableConfigs { get; set; }
            public AbilityConfigs AbilityConfigs { get; set; }
            public DropItemConfigs DropItemConfigs { get; set; }
            public Dictionary<string, UpgradeConfig> UpgradeConfigs { get; set; }
            public BotConfigs BotConfigs { get; set; }
            public CardPresetConfigs CardPresetConfigs { get; set; }
            public bool GameModesBan { get; set; }
        }
